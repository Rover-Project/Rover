...
from rover.core.movement_loader import load_motor
from rover.modules.movement.robot import Robot
from rover.modules.movement.calibration import MotorCalibration
...
def test(backend, speed):
    ...
    print("\n")
    click.echo("⬅️ Girando esquerda")
    robot.turn_left(speed, duration=2)
    print("\n")
    click.echo("➡️ Girando direita")
